...
function SpiritAnimalIntroductionPage() {
  return (
    <>
      <Helmet>
        <title>靈性動物介紹 - 妙雷宗婚禮儀式 - 妙法無邊雷射蓮花</title>
        <meta name="description" content="婚禮中使用的靈性動物介紹" />
        <meta property="og:title" content="靈性動物介紹 - 妙雷宗婚禮儀式" />
      </Helmet>
...
export default SpiritAnimalIntroductionPage
