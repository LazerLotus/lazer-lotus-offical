...
function DivorceCeremonyPage() {
  return (
    <>
      <Helmet>
        <title>離婚儀式 - 妙雷宗婚禮儀式 - 妙法無邊雷射蓮花</title>
        <meta name="description" content="妙雷宗莊嚴的離婚儀式" />
        <meta property="og:title" content="離婚儀式 - 妙雷宗婚禮儀式" />
      </Helmet>
...
export default DivorceCeremonyPage
