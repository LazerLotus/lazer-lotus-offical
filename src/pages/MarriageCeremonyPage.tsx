...
function MarriageCeremonyPage() {
  return (
    <>
      <Helmet>
        <title>結婚儀式 - 妙雷宗婚禮儀式 - 妙法無邊雷射蓮花</title>
        <meta name="description" content="妙雷宗神聖的結婚典禮儀式" />
        <meta property="og:title" content="結婚儀式 - 妙雷宗婚禮儀式" />
      </Helmet>
...
export default MarriageCeremonyPage
